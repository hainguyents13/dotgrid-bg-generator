...
/** Biểu tượng mắt, gạch chéo khi lớp đang ẩn. */
function EyeIcon({ off }) {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
      strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M1.8 12S6 5.5 12 5.5 22.2 12 22.2 12 18 18.5 12 18.5 1.8 12 1.8 12z" />
...
function LayerRow({ layer, index, total, selected, onSelect, onToggle, onMove, onRename, onDelete }) {
  return (
    ...
    >
      <button
        className={"icon eye" + (layer.visible ? "" : " off")}
        type="button"
